...
@white_halo:        fadeout(white,30%);

@country_text:      #435;
@country_halo:      @white_halo;

@state_text:        #546;
@state_halo:        @white_halo;

@city_text:         #444;
@city_halo:         @white_halo;

@town_text:         #666;
@town_halo:         @white_halo;

@airport_text:      #42668A;
@airport_halo:      @white_halo;

@depot_text:        #924F46;
@depot_halo:        @white_halo;

@subway_text: 		#C1312F;
@subway_halo: 		@white_halo;

@railway_text: 		#707070;
@railway_halo: 		@white_halo;
