...
#motorway_label[zoom>=11][zoom<=14][reflen<=8] {
  ...
  shield-fill: #fff;
  shield-file: url(img/shield/shield-motorway-1.png);
  [type='motorway'] {
    [reflen=1] { shield-file: url(img/shield/shield-motorway-1.png); }
    [reflen=2] { shield-file: url(img/shield/shield-motorway-2.png); }
    [reflen=3] { shield-file: url(img/shield/shield-motorway-3.png); }
    [reflen=4] { shield-file: url(img/shield/shield-motorway-4.png); }
    [reflen=5] { shield-file: url(img/shield/shield-motorway-5.png); }
    [reflen=6] { shield-file: url(img/shield/shield-motorway-6.png); }
    [reflen=7] { shield-file: url(img/shield/shield-motorway-7.png); }
    [reflen=8] { shield-file: url(img/shield/shield-motorway-8.png); }
  }
  [type='trunk'] {
    [reflen=1] { shield-file: url(img/shield/shield-trunk-1.png); }
    [reflen=2] { shield-file: url(img/shield/shield-trunk-2.png); }
    [reflen=3] { shield-file: url(img/shield/shield-trunk-3.png); }
    [reflen=4] { shield-file: url(img/shield/shield-trunk-4.png); }
    [reflen=5] { shield-file: url(img/shield/shield-trunk-5.png); }
    [reflen=6] { shield-file: url(img/shield/shield-trunk-6.png); }
    [reflen=7] { shield-file: url(img/shield/shield-trunk-7.png); }
    [reflen=8] { shield-file: url(img/shield/shield-trunk-8.png); }
  }
