...
#landuse_overlays[type='wetland'][zoom>11] {
  [zoom>11][zoom<=14] { polygon-pattern-file:url(img/pattern/marsh-16.png); }
  [zoom>14] { polygon-pattern-file:url(img/pattern/marsh-32.png);}
  }

#landuse_overlays[type='cemetery'][zoom>11] {
  [zoom>11][zoom<=14] { polygon-pattern-file:url(img/pattern/cemetery-16.png); }
  [zoom>14] { polygon-pattern-file:url(img/pattern/cemetery-32.png);}
  }
